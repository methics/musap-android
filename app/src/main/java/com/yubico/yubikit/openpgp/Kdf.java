...
public abstract class Kdf {
    ...
    public static class IterSaltedS2k extends Kdf {
        ...
        private final byte[] saltReset;
        
        private final byte[] saltAdmin;
        
        private final byte[] initialHashUser;
        ...
        public IterSaltedS2k(
                ...
                byte[] saltUser,
                 byte[] saltReset,
                 byte[] saltAdmin,
                 byte[] initialHashUser,
                 byte[] initialHashAdmin
        ) {
            super((byte) 3);
        ...
        public static IterSaltedS2k create(HashAlgorithm hashAlgorithm, int iterationCount) {
            ...
            return new IterSaltedS2k(
                    ...
                    saltAdmin,
                    doProcess(hashAlgorithm, iterationCount, ByteBuffer.allocate(8 + defaultUserPinEncoded.length)
                            .put(saltUser)
                            .put(defaultUserPinEncoded)
                            .array()),
                    doProcess(hashAlgorithm, iterationCount, ByteBuffer.allocate(8 + defaultAdminPinEncoded.length)
                            .put(saltAdmin)
