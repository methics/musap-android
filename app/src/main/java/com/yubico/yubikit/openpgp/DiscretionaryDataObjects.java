...
public class DiscretionaryDataObjects {
    static private final int TAG_EXTENDED_CAPABILITIES = 0xC0;
    static private final int TAG_FINGERPRINTS = 0xC5;
    static private final int TAG_CA_FINGERPRINTS = 0xC6;
    static private final int TAG_GENERATION_TIMES = 0xCD;
    static private final int TAG_KEY_INFORMATION = 0xDE;
    ...
    private final AlgorithmAttributes attributesAtt;
    ...
    private final Uif uifSig;
    
    private final Uif uifDec;
    
    private final Uif uifAut;
    ...
    public DiscretionaryDataObjects(
            ...
            AlgorithmAttributes attributesAut,
             AlgorithmAttributes attributesAtt,
            PwStatus pwStatus,
