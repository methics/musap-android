...
public class ApplicationRelatedData {
    static private final int TAG_DISCRETIONARY = 0x73;
    private final OpenPgpAid aid;
    private final byte[] historical;
    
    private final ExtendedLengthInfo extendedLengthInfo;
    ...
    public ApplicationRelatedData(
            OpenPgpAid aid,
            byte[] historical,
             ExtendedLengthInfo extendedLengthInfo,
             EnumSet<GeneralFeatureManagement> generalFeatureManagement,
