...
public abstract class PrivateKeyValues implements Destroyable {
    ...
    public static class Rsa extends PrivateKeyValues {
        ...
        protected Rsa(BigInteger modulus, BigInteger publicExponent, BigInteger primeP, BigInteger primeQ,  BigInteger primeExponentP,  BigInteger primeExponentQ,  BigInteger crtCoefficient) {
