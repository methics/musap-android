...
public class PivKeyStoreSpi extends KeyStoreSpi {
    ...
    private void putEntry(Slot slot,  PrivateKey key, PinPolicy pinPolicy, TouchPolicy touchPolicy,  X509Certificate certificate) throws Exception {
    ...
    public void engineSetEntry(String alias, KeyStore.Entry
            entry,  KeyStore.ProtectionParameter protParam) throws KeyStoreException {
        Slot slot = Slot.fromStringAlias(alias);
