...
public abstract class PivPrivateKey implements PrivateKey, Destroyable {
    ...
    static PivPrivateKey from(PublicKey publicKey, Slot slot,  PinPolicy pinPolicy,  TouchPolicy touchPolicy,  char[] pin) {
    ...
    protected PivPrivateKey(Slot slot, KeyType keyType,  PinPolicy pinPolicy,  TouchPolicy touchPolicy,  char[] pin) {
        this.slot = slot;
    ...
    static class EcKey extends PivPrivateKey implements ECKey {
        ...
        private EcKey(Slot slot, KeyType keyType,  PinPolicy pinPolicy,  TouchPolicy touchPolicy, ECParameterSpec ecSpec,  char[] pin) {
    ...
    static class RsaKey extends PivPrivateKey implements RSAKey {
        ...
        private RsaKey(Slot slot, KeyType keyType,  PinPolicy pinPolicy,  TouchPolicy touchPolicy, BigInteger modulus,  char[] pin) {
            super(slot, keyType, pinPolicy, touchPolicy, pin);
